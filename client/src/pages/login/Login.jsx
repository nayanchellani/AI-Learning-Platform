    ...
    <div className="auth-page">
      ...
      <div className="auth-form-side">
        <div className="auth-card">
          <h2 className="auth-card-title">Login Now</h2>
          ...
          <p className="auth-switch-text">
            Don't have an account? <Link to="/signup" className="auth-switch-link">Register</Link>
          </p>
        </div>
        
        {/* Decorative chevrons behind card (right side) */}
